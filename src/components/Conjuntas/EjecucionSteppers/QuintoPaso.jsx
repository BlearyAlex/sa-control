...
import { ModalResultados } from '../../../views/Ejecucion/Components/Conjuntas';
  ...
  return (
    <div className="px-6 py-4">
      <div className="flex-1">
        <h1 className="text-3xl">Resultados Preliminares</h1>
        <div>
          <p>Listado de Resultados Preliminares en Generall</p>
        </div>
        <div>
