...
import { ModalOficioCitacion } from '../../../views/Ejecucion/Components/Conjuntas';
    ...
    <div className="px-6 py-4">
      <div className="flex-1">
        <h1 className="text-3xl">
          Oficio de citación para notificación de resultados preliminares
      ...
      {modal === true && <ModalOficioCitacion />}
