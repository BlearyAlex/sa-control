        ...
        return (
          <span
            className={classNames({
              ...
              'bg-red-500': 'Planeacion' === info.getValue(),
              'bg-green-500': 'Ejecucion' === info.getValue(),
              'bg-blue-500': 'Seguimiento' === info.getValue(),
              'bg-pink-500': 'Informe' === info.getValue(),
              'bg-violet-500': 'Conclusión' === info.getValue(),
            })}
          >
            {info.getValue()}
          </span>
  ...
  return (
    <div className="px-6 py-4">
      <div className="flex-1">
        <h1 className="text-3xl">Auditorias</h1>
        <div>
          <p>Listado de Auditorias en General</p>
        </div>
      </div>
      <div className="my-2 flex justify-end">
        <div className="relative">
          <Link to={'/nueva-auditoria'}>
            <div
