...
import {
  PrimerPaso,
  Final,
} from '../../components/Conjuntas/ConclusionSteppers';

function ConclusionConjuntas() {
  const [currentStep, setCurrentStep] = useState(1);

  const steps = ['Primer Paso', 'Completado'];
...
export default ConclusionConjuntas;
