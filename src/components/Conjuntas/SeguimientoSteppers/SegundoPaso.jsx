...
import { ModalOficioEntrega } from '../../../views/Seguimiento/Components/Conjuntas';
    ...
    <div className="px-6 py-4">
      <div className="flex-1">
        <h1 className="text-3xl">
          Oficio de entrega de documentación para la atención de resultados
          definitivos emitido por la Dependencia o Entidad fiscalizada
        </h1>
        <div>
