...
import { ModalObservacion } from '../../../views/Seguimiento/Components/Directas';
...
export const CuartoPaso = () => {
  ...
  const columns = [
    ...
    {
      accessorKey: 'MontoNoSolventado',
      header: () => <span>Resultado de la Valoración</span>,
    },
    {
      accessorKey: 'MontoNoSolventado',
      header: () => <span>Solventación Media Correctiva</span>,
    },
    {
      accessorKey: 'MontoNoSolventado',
      header: () => <span>Solventación Media Preventiva</span>,
    },
    {
      accessorKey: 'MontoNoSolventado',
