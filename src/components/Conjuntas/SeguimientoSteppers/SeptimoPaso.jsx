...
import { ModalOficioEnvio } from '../../../views/Seguimiento/Components/Conjuntas';
    ...
    <div className="px-6 py-4">
      <div className="flex-1">
        <h1 className="text-3xl">
          Oficio de envío de documentación adicional en atención a los
          resultados definitivos y valoración de dicha documentación, emitido
          por la SFPZ a la SFPF
        </h1>
        <div>
