...
import { ModalResDefinitivo } from '../../../views/Seguimiento/Components/Conjuntas';
...
export const SextoPaso = () => {
  ...
  const columns = [
    ...
    {
      accessorKey: 'montoSolventado',
      header: () => <span>Monto Solventado</span>,
      cell: (info) => <span className="font-bold">{info.getValue()}</span>,
    },
    {
      accessorKey: 'montoNoSolventado',
      header: () => <span>Monto No Solventado</span>,
      cell: (info) => <span className="font-bold">{info.getValue()}</span>,
    },
    {
      accessorKey: 'medidaPreventiva',
      header: () => <span>Solventacion Medida Preventiva</span>,
      cell: (info) => <span className="font-bold">{info.getValue()}</span>,
    },
    {
      accessorKey: 'medidaCorrectiva',
      header: () => <span>Solventacion Medida Correctiva</span>,
      cell: (info) => <span className="font-bold">{info.getValue()}</span>,
    },
    {
    ...
    <div className="px-6 py-4">
      <div className="flex-1">
        <h1 className="text-3xl">
          Estatus realizado por la SFPZ a los resultados definitivos, posterior
          al análisis efectuado a la documentación adicional
        </h1>
        <div>
          <p>Listado de Resultados Definitivos en General</p>
        </div>
        <div>
