...
import { ModalDocPosteriores } from '../../../views/Seguimiento/Components/Conjuntas';
  ...
  const columns = [
    {
      ...
      header: () => <span>Seguimiento Posterior</span>,
  ...
  return (
    <div className="px-6 py-4">
      <div className="flex-1">
        <h1 className="text-3xl">Seguimientos Posteriores</h1>
        <div>
      ...
      {modal === true && <ModalDocPosteriores />}
