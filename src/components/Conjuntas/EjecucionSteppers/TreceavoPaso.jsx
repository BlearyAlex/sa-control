    ...
    <div className="px-6 py-4">
      <div className="flex-1">
        <h1 className="text-3xl">
          Oficio de citación para notificación de resultados definitivos,
          emitido por la SFPZ en conjunto con la SFPF a las Dependencias y
