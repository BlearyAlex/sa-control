...
import { ModalEstatusDefinitivo } from '../../../views/Seguimiento/Components/Conjuntas';
  ...
  return (
    <div className="px-6 py-4">
      <div className="flex-1">
        <h1 className="text-3xl">Estatus De Resultados Definitivos</h1>
        <div>
      ...
      {modal === true && <ModalEstatusDefinitivo />}
